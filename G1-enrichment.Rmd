...
plot_G1G2_percentages <- function(Data) {
  ...
  ggplot(Data,
    ...
    labs(y = "Percentage",
         x = NULL,
         title = "% of G1 & G2 Cells With or Without G1-Enrichment") +
    scale_color_manual(values = palette[1:2] %>% set_names(c("CTL","IR"))) +
...
plot_fc_G1_G2 <- function(Data) {
  ...
  ggplot(Data) +
    ...
    labs(title = "Fold Change G1 & G2 Cells After G1-Enrichment",
...
# # only IR
# plot_fc_G1_G2(df_DNA_content_fc %>%
#                 filter(Condition == "IR")) +
#   labs(title = "Fold Change G1 % (SS vs FS)",
#        y = "Fold Change (SS vs FS)"
#        )

# # SS only
# plot_fc_G1_G2(df_DNA_content_fc %>%
#                 filter(Condition == "IR", Serum == "SS")) +
#   labs(title = "Fold Change G1 G2 in IR (SS vs FS)",
#        y = "Fold Change (SS vs FS)"
#        )

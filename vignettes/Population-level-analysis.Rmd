...
var_interval_start <- grep(all_var_names, pattern = "NintAll_c2_overall")
...
plot_2D_fold_change(df_fc_clean_HMVECL, x = "NintAll_c2_overall_fc", y = "NintAll_c3_overall_fc", faceting_Ch2 = TRUE)
plot_2D_fold_change(df_fc_clean_IMR90, x = "NintAll_c2_overall_fc", y = "NintAll_c3_overall_fc", faceting_Ch2 = TRUE)
...
plot_2D_fold_change(df_fc_clean_HMVECL_p21,
                    x = "NintAll_c2_overall_fc",
                    y = "NintAll_c3_overall_fc",
                    xlab = "Fold Change 1st Marker \n(p21)")
...
end_var <- grep("NintAll_c3_overall_fc_sd", colnames(df_fc_clean))
...
plot_2D_fold_change_mean_sd(df_summary_HMVECL,
                            x = "NintAll_c2_overall_fc_mean", x_sd = "NintAll_c2_overall_fc_sd",
                            y = "NintAll_c3_overall_fc_mean", y_sd = "NintAll_c3_overall_fc_sd",
                            faceting_Ch2 = TRUE)
